...
const Signup = () => {
    ...
    return (
        <AuthLayout>
            <div className="">
                <div className="">
                    <div className="mt-6 px-12 sm:px-24 md:px-24 lg:px-12  xl:px-18 max-w-xl mx-auto shadow-2xl py-4 rounded-xl">
                        <div className='flex justify-center items-center'>
                            <h2 className="  text-2xl text-orange-600 font-display font-semibold mr-2  xl:text-3xl
          xl:text-bold">{t('Đăng ký')}</h2>
                            <img width={35} src="https://movie-booking-project.vercel.app/img/headTixLogo.png" alt="logo" />
                        </div>
                        <div className="mt-8">
                            <Formik
                                initialValues={{
